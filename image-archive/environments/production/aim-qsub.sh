...
export INPUT_FILE_LIST=${INPUT_FILE_LIST:-~/Disk1_Part_aa} # use variable or default
...
echo "python /home/dsnider/aim-platform/image-archive/de-id/load_elastic.py $INPUT_FILE_LIST $OUTPUT_THUMBNAIL_DIR -n $ES_BLUK_INSERT_SIZE"
