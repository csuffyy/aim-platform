...
export PUBLIC_IP='192.168.136.129'
export ELASTIC_IP='192.168.136.129'
export FALLBACK_ELASTIC_IP='192.168.136.129'
...
export ELASTIC_URL='http://192.168.136.129:9200/'
export REPORT_ELASTIC_INDEX='report'
export REPORT_ELASTIC_DOC_TYPE='report'
export FILESERVER_IP='192.168.136.129'
...
export STATIC_WEBSERVER_URL='http://192.168.136.129:3000/'
export DWV_URL='http://192.168.136.129:8080/'
